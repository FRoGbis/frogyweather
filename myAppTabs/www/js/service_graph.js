angular.module('starter.service_graph', [])
    ...
    .factory('Graphs', function () {
        ...
        var chartConfig_full = {
            options: {
                chart: {
                    zoomType: ['x', 'y']
                },
                title: {
                    text: 'Full data graphique'
                },
                subtitle: {
        ...
        return {
            ...
            getConfig_full: function () {
                return chartConfig_full;
            }
        }
    });